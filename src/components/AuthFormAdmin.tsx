    ...
    try {
      ...
      if (isLogin) {
        ...
        if (!success) {
          ...
          // Registro exitoso, cambiar a modo login o redirigir

          // Para usuario regular, mostrar mensaje de éxito y cambiar a login
          setError('');
          setIsLogin(true);
          setFormData({ email: formData.email, password: '', name: '' });
          // O también podrías redirigir directamente si el registro hace login automático
